...
import JejuBookingForm from "./jeju-booking-form";
import { track } from "@/lib/analytics";
import { useTranslation } from "@/hooks/use-translation";

interface JejuBookingDrawerProps {
  children: React.ReactNode;
}

export default function JejuBookingDrawer({
  children,
}: JejuBookingDrawerProps) {
    ...
    <Drawer open={isModalOpen} onOpenChange={handleOpenChange}>
      ...
      >
        <DrawerHeader className="flex-shrink-0 text-left">
          <DrawerTitle>{tData.title || "제주 택시투어 예약하기"}</DrawerTitle>
        </DrawerHeader>
