    ...
    <>
      <div className="grid grid-cols-2 mt-2 rounded-3xl overflow-hidden">
        ...
        <div className="grid grid-cols-2 overflow-hidden">
          ...
          <div className="overflow-hidden">
            <img
              className="rounded-tr-3xl object-cover transition duration-300 ease-in-out hover:scale-110 cursor-pointer"
              src={IMAGES[2]}
              alt={name}
          ...
          <div className="overflow-hidden">
            <img
              className="rounded-br-3xl object-cover transition duration-300 ease-in-out hover:scale-110 cursor-pointer"
              src={IMAGES[4]}
              alt={name}
