...
interface Props {
  ...
  setPlaceData: Dispatch<SetStateAction<Destination[]>>;
}
...
function DestinationModal({
  ...
  const [destinationInfo, setDestinationInfo] = useState<Place>();
