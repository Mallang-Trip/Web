  ...
  return (
    <div className="w-full sm:w-3/5 mx-auto mt-14">
      ...
      >
        ...
        <FeeTable />
        <div>
          다른 여행자의 예약 취소로 인해 2명 이상 공석이 발생한 시점부터 24시간
          동안 위약금 무료로 취소할 지 또는
          <br />
          남은 여행자와 안내된 잔금을 결제하여 환불 불가능한 상태로 여행을 최종
          확정할 지 선택할 수 있습니다.
          <br />이 때 여행을 최종 확정하기 위해서는 24시간 내에 여행자 전원이
          여행 최종 선택을 <span className="text-primary">만장일치</span>해야
          합니다.
          <br />
          <span className="text-[#FF0000]">그렇지 않을 경우</span> 24시간이
          지나면 <span className="text-primary">자동으로 무료 예약 취소</span>
          됩니다.
          <br />
          여행자 중 누군가가 별도로 선택을 하지 않고 24시간이 지나도 무료 예약
          취소로 진행됩니다.
          <br />
        </div>
        <div>
          최종적으로 여행이 전체 취소되면 여행자들이 지불한 위약금의 90%는
          드라이버에게 지급하고,
          <br />
          10%는 말랑트립의 수수료로 합니다.
          <br />
          여행 최종 선택이 진행되면 안내된 총 수익 그대로 드라이버에게
          지급합니다.
          <br />
        </div>
      </div>
