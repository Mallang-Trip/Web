...
function ReceiptModal({
  ...
  const driverPenaltyCompleteFunc = async () => {
    try {
          ...
          <div className="w-full flex flex-col h-3/5 px-6 bg-white rounded-t-xl">
            ...
            <div>
              ...
              <div className="flex justify-between items-center gap-2">
                <div className="w-60 h-14 px-3 flex items-center gap-3 border border-mediumgray rounded-lg">
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    {receiptInfo.driverPenaltyAmount && (
                      <p
                        className={`text-xs font-medium ${receiptInfo.driverPenaltyStatus === "PENALTY_PAYMENT_COMPLETE" ? "text-primary" : "text-[#FF0000]"}`}
                      >
                ...
                {receiptInfo.driverPenaltyAmount ? (
                  <button
                    className={`w-24 h-14 text-sm font-bold border rounded-lg ${
