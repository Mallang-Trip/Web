...
function ReportContent({ setCurrent }) {
  ...
  const getReportDetailFunc = async () => {
    try {
      const result =
        status === "WAITING"
  ...
  const updateReportCompleteFunc = async () => {
    try {
  ...
  const goCoupleChat = async (userId) => {
    try {
  ...
  return (
    <div>
      <div className="flex flex-col">
        ...
        <div className="flex">
          <div
            className="flex items-center px-5 py-3 text-sm font-bold rounded-xl bg-[#FFEAEA] mr-3 cursor-pointer"
            onClick={() => {
        ...
        {status === "WAITING" ? (
          ...
          <div className="flex flex-col mt-10">
            ...
            <div className="flex w-full mb-5">
              ...
              <div
                className={`pl-5 flex items-center text-base font-medium border border-gray300 rounded-xl flex-1 ${reportDetail.suspensionExist ? "text-primary" : "text-[#FF0000]"}`}
              >
