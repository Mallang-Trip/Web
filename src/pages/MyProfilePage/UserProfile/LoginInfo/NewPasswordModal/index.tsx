...
function NewPasswordModal({ showModal, setShowModal }: Props) {
  ...
  const nowPasswordHandler = useCallback((e: ChangeEvent<HTMLInputElement>) => {
  ...
  const newPasswordAgainHandler = useCallback(
