...
function DriverPrivacy() {
  return (
    <PageContainer>
      <HeadTitle title={"말랑트립 개인정보 처리방침(드라이버회원용)"} />

      <PolicyContainer>
        <BodyContent title={"제 1 조 (개인정보 처리목적)"}>
          ...
          <BodyTab>
            1. 드라이버 등록 및 관리
            <BodyTab>
              드라이버 등록 의사 확인, 본인 식별·인증, 자격 인증, 드라이버 자격
              유지·관리, 서비스 부정이용 방지, 각종 고지·통지, 고충처리 등을
              목적으로 개인정보를 처리합니다.
            </BodyTab>
          </BodyTab>
          <br />
          <BodyTab>
            2. 플랫폼 서비스 제공
            <BodyTab>
              서비스 제공, 계약의 체결 및 예약 관리, 대금 정산, 채권추심 등을
              목적으로 개인정보를 처리합니다.
            </BodyTab>
          </BodyTab>
          <br />
        ...
        <BodyContent title={"제 2 조 (개인정보의 처리 및 보유기간)"}>
          ...
          <BodyTab>
            ...
            <BodyTab>
              ...
              수사·조사 종료 시까지
              <br />
              2) 서비스 이용에 따른 채권·채무관계 잔존 시에는 해당 채권·채무관계
              정산 시까지
            </BodyTab>
          </BodyTab>
          <br />
          <BodyTab>
            2. 플랫폼 서비스 제공 : 서비스 공급 완료 및 대금 정산 완료 시까지
            <BodyTab>
        ...
        <BodyContent title={"제 3 조 (처리하는 개인정보 항목)"}>
          ...
          1. 드라이버 등록 및 관리
          <BodyTab>
            · 필수항목 : 성명, 닉네임, 이메일, 비밀번호, 휴대전화번호, 주소,
            면허정보, 범죄경력정보, 보험증서, 주민등록번호, 프로필사진, 성별,
            계좌정보, 드라이브 서비스 관련 정보, 소개글, 드라이버에 대한 제재
            내역
          </BodyTab>
          <br />
          2. 서비스 제공
        ...
        <BodyContent title={"제 4 조 (개인정보의 제3자 제공)"}>
          ...
          <BodyTab>
            ...
            <br />
            - 제공하는 개인정보 항목 : 성명, 차종, 차량번호, 연락처, 프로필
            사진, 서비스 가격, 서비스 제공 가능 지역, 자기 소개, 다른 회원들의
            평가 내역, 그 외 드라이버가 웹사이트 및 앱을 통해 직접 공개 설정한
            정보
          ...
          <BodyTab>
            ...
            - 제공하는 개인정보 항목 : 성명, 프로필 사진, 차종, 서비스 가격,
            서비스 제공 가능 지역, 자기 소개, 다른 회원들의 평가 내역, 그 외
            드라이버가 웹사이트 및 앱을 통해 직접 공개 설정한 정보 <br />-
        ...
        >
          ...
          <br />
          <BodyTab>
            가. 쿠키의 사용목적: 이용자의 웹사이트 및 앱에 대한 방문 및
        ...
        <BodyContent title={"제 10 조 (추가적인 이용·제공 판단기준)"}>
          ...
          <br />
          <BodyTab>
            1. 항목 : 성명, 연락처, 이메일, 드라이브 서비스 예약 및 제공 내역,
            드라이버에 대한 제재 내역, 대금 정산 내역
            <br />
            <br />
...
export default memo(DriverPrivacy);
