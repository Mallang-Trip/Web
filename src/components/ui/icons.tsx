  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth={2}
        d="M3 7h14a2 2 0 012 2v10a2 2 0 01-2 2H3a2 2 0 01-2-2V9a2 2 0 012-2zm0-4h10l4 4"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M17 20h5v-2a4 4 0 00-5-3.87M9 20H4v-2a4 4 0 015-3.87m0 0a4 4 0 100-8 4 4 0 000 8m10 0a4 4 0 10-8 0"
      />
    </svg>
  );
}
...
export function CloseCircleIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
