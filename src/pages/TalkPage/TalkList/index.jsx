...
function TalkList({ chatList, openTalkId, setOpenTalkId, getChatListFunc }) {
  ...
  return (
    <aside className="fixed top-14 left-0 z-30 w-full md:w-[450px] h-real-screen">
      <div className="overflow-y-auto pb-32 md:pb-20 px-3 h-full bg-white md:border-r border-mediumgray noScrollBar">
        ...
        {sortedChatList.length > 0 ? (
          <ul className="space-y-2 border-b border-solid border-mediumgray py-3 mb-5">
