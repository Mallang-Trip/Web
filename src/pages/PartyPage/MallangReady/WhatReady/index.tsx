...
function WhatReady() {
  ...
  return (
    <div>
      ...
      >
        <p>
          가입된 일행들끼리 여행을 확정하고 여행비 결제를 진행하기 위해
          드라이버를 포함한 모든 일행들이 투표하는 것을 말합니다.
          <br />
          말랑레디 버튼을 클릭해서 말랑레디 ON 상태로 바꿀 수 있습니다.
        </p>
        <p className="mt-3">
          <span className="text-primary">
            모든 일행들이 말랑레디 버튼을 ON으로 선택하면 예약금 결제가
            이루어지며, 이후에는 위약금 정책이 적용됩니다.
          </span>
          <br />
          말랑레디를 여행 당일 전까지 만장일치하지 못한다면 일정은 자동으로
          해산됩니다.
          <br />
          말랑레디를 일행들과 상의하여 결정해보세요!
          <br />
        </p>
      </div>
    </div>
