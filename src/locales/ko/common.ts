const common = {
  ...
  detail: {
    ...
    pickupDropoff: {
      ...
      notice1:
        "픽업 및 드랍 장소는 제한 없이 지정 가능하지만, 계획된 경로를 크게 벗어나거나 다회 픽업/드랍의 경우, ",
      notice1Bold: "추가 이동에 대한 요금",
      notice1End: "이 발생할 수 있습니다.",
    ...
    bookingForm: {
      ...
      toast: {
        ...
        paymentErrorDesc: "문제가 지속되면 고객센터로 문의해주세요.",
        ...
        popupBlockedDesc: "팝업 차단을 해제하고 다시 시도해주세요.",
      },
    },
  },
};
