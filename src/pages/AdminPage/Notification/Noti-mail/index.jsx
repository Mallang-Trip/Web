...
function NotiMail() {
  ...
  const setFilterColor = (isFilterOn) => {
  ...
  return (
    <div className="font-medium text-base ">
      ...
      <div className="flex justify-between mb-3">
        <div className="flex">
          <button
            className={`px-4 py-3 rounded-full text-sm font-semibold border mr-2 ${setFilterColor(isFilterUser)}`}
            onClick={() => {
          ...
          <button
            className={`px-4 py-3 rounded-full text-sm font-semibold border mr-2 ${setFilterColor(isFilterDriver)}`}
            onClick={() => {
          ...
          {current === 0 ? (
            <button
              className={`flex items-center px-4 py-3 rounded-full text-sm font-semibold border border-mediumgray text-darkgray`}
            >
            ...
            <button
              className={`flex items-center px-4 py-3 rounded-full text-sm font-semibold border ${setFilterColor(isFilterAll)}`}
              onClick={() => {
